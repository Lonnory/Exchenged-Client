...
class ExchengedClientApplication: Application() {
    ...
    private fun initUpdateSystem() {
        appCoroutineScope.launch {
            ...
            val interval = prefs[SettingsKeys.UPDATE_CHECK_INTERVAL] ?: 24L
            val emergencyTime = prefs[SettingsKeys.EMERGENCY_UPDATE_TIME] ?: "03:00"
            val emergencyDay = prefs[SettingsKeys.EMERGENCY_UPDATE_DAY] ?: -1
            
            UpdateWorkHelper.scheduleUpdateCheck(this@ExchengedClientApplication, interval)
            UpdateWorkHelper.scheduleEmergencyUpdateCheck(this@ExchengedClientApplication, emergencyTime, emergencyDay)
        }
    }
