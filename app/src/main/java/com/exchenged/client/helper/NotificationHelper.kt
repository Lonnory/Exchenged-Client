package com.exchenged.client.helper
...
class NotificationHelper @Inject constructor(
    ...
    private var notificationView =
        RemoteViews("com.exchenged.client", R.layout.notification_traffic_layout)
    private var bigNotificationView=
        RemoteViews("com.exchenged.client",R.layout.big_notification_traffic_layout)
    ...
    val liveBuilder: NotificationCompat.Builder = NotificationCompat.Builder(context,CHANNEL_ID)
        ...
        .setOngoing(true)
        .setShortCriticalText("ExchengedClient")
