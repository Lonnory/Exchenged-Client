...
class SettingsViewmodel(
    ...
    fun setManualSubName(name: String) {
        viewModelScope.launch {
            repository.setManualSubName(name)
        }
    }
    ...
    fun setSubUpdateInterval(context: Context, minutes: Long) {
        viewModelScope.launch {
            repository.setSubUpdateInterval(minutes)
            UpdateWorkHelper.scheduleSubUpdateCheck(context, minutes)
        }
    }
