...
import com.exchenged.client.common.di.qualifier.LongTime
import com.exchenged.client.common.utils.calculateFileHash
...
class SettingsViewmodel(
    ...
    companion object {
        const val REPO = "https://github.com/Lonnory/Exchenged-Client"
    ...
    fun setAppTheme(theme: com.exchenged.client.common.model.AppTheme) {
        viewModelScope.launch {
            repository.setAppTheme(theme)
        }
    }

    fun setAppWallpaper(wallpaper: com.exchenged.client.common.model.AppWallpaper) {
        viewModelScope.launch {
            repository.setAppWallpaper(wallpaper)
        }
    }

    fun setAppLanguage(language: com.exchenged.client.common.model.AppLanguage) {
        viewModelScope.launch {
            repository.setAppLanguage(language)
        }
    }

    fun setEmojiWorkshopConfig(config: String) {
        viewModelScope.launch {
            repository.setEmojiWorkshopConfig(config)
        }
    }
    ...
    fun setPingType(pingType: PingType) {
        viewModelScope.launch {
            repository.setPingType(pingType)
        }
    }
    ...
    fun setUpdateCheckInterval(context: Context, hours: Long) {
        viewModelScope.launch {
            repository.setUpdateCheckInterval(hours)
            UpdateWorkHelper.scheduleUpdateCheck(context, hours)
        }
    }

    fun setEmergencyUpdateTime(context: Context, time: String) {
        viewModelScope.launch {
            repository.setEmergencyUpdateTime(time)
            UpdateWorkHelper.scheduleEmergencyUpdateCheck(context, time, settingsState.value.emergencyUpdateDay)
        }
    }

    fun setEmergencyUpdateDay(context: Context, day: Int) {
        viewModelScope.launch {
            repository.setEmergencyUpdateDay(day)
            UpdateWorkHelper.scheduleEmergencyUpdateCheck(context, settingsState.value.emergencyUpdateTime, day)
        }
    }

    fun setDeveloperMode(enable: Boolean) {
        viewModelScope.launch {
            repository.setDeveloperMode(enable)
        }
    }

    fun setDeveloperUnlocked(unlocked: Boolean) {
        viewModelScope.launch {
            repository.setDeveloperUnlocked(unlocked)
        }
    }
